...
def benchmark_comprehensive_performance():
    ...
    test_images_dir = "datasets/maritime/test/images"
    ...
    print("=" * 80)
    print("• Following paper section 2.6 Evaluation Metrics")
    print("• 1000 inference iterations per device")
...
def get_comprehensive_performance_metrics():
    """
    Main function to get comprehensive performance metrics
    Returns workstation and embedded performance statistics
    """
